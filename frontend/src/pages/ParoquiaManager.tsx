...
const ParoquiaManager: React.FC = () => {
  ...
  return (
    <div className="container mt-4">
      <AdminIdentityHeader
        title="⚙️ Configurar Minha Paróquia"
        subtitle="Gerenciar dados da paróquia, contato e informações financeiras"
        backTo="/admin-paroquia/dashboard"
        rightContent={
          !paroquia ? (
            <button
...
export default ParoquiaManager;
